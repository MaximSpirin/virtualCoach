...
/*    p.initialize = function(){
    ...
    p.render = function(){
        ...
        if(this.lineContainer.numChildren == 0){
            ...
            this.lineContainer.setBounds(0, 0, this.rendererData.lineWidth, DribblingLineSegment.STD_HEIGHT);
        }
        ...
        if(this.rendererData.direction == "rtl"){
            ...
            this.lineContainer.scaleX = -1;
            this.lineContainer.x = this.lineContainer.getBounds().width;
        }
    ...
    p.getContentBounds = function(){
        ...
        //var contentPosInParentCS = this.localToLocal(this.container.x - containerBounds.width/2, this.container.y - containerBounds.height/2, this.parent);
